...
- Name: self-serve-group-sizes.spec.ts >> self-serve match building -- exact and overflow invite pools >> 2-player match, overflow invite pool (2 invited for 1 spot)
- Location: specs\self-serve-group-sizes.spec.ts:69:7
